...
export default function EventCard({
    ...
    return (
        ...
        >
            <div className="absolute top-5 right-5 text-right text-xs space-y-1">
                {isLive ? (
                    ...
                    <div className="text-gray-500 font-medium font-lora text-sm">{dayLabel}</div>
                )}
                <div className="text-black font-bold font-lora text-[14px]">{time}</div>
            </div>
            ...
            <div className="flex-1  pr-20">
                <h3 className="text-[22px] font-bold text-gray-900 font-cormorant">{title}</h3>
                <p className="text-sm text-[#555555] line-clamp-2 font-lora text-[16px]">{description}</p>
