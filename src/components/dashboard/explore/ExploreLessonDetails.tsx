...
export default function ExploreLessonDetails({ lesson }: CourseDetailsProps) {
  ...
  return (
    <div className=" flex flex-col font-lora gap-7">
      <div className="text-sm flex font-open-sans gap-2 text-gray-600">
        <Link href={`/dashboard/explore-courses`}>
        ...
        {' / '}
        <Link href={`/dashboard/explore-courses/${courseSlug}`}>
          <span className="flex items-center gap-1 hover:underline text-gray-500">
            {courseSlug}
          </span>
        </Link>
              ...
              response.next_lessons.map((nextLesson, index) => (
                ...
                >
                  ...
                  <div className='w-full'>
                    <Link href={`/dashboard/explore-courses/${courseSlug}/lesson/${nextLesson?.slug}`}>
                      <div
...
//                 <div className="w-full">
//                   <Link
//                     href={`/dashboard/explore-courses/${courseSlug}/lesson/${nextLesson?.slug}`}
//                   >
